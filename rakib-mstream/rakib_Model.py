...
class Model:
    ...
    def detectOutlierAndEnhanceByEmbedding(self, documentSet, wordVectorsDic):
      ...
      appendResultFile(non_outlier_pred_true_text_ind_prevPreds, 'rakib_mstream_result/mstr-enh')
    ...
    def detectOutlierForgetEnhanceByEmbeddingSimProduct_DUAL(self, documentSet, skStopWords, wordVectorsDic):
      ...
      if self.batchNum>0: #or self.batchNum==24:
        ...
        appendResultFile(flat_outs, 'rakib_mstream_result/mstr-enh')
    ...
    def run_MStream(self, documentSet, outputPath, wordList, AllBatchNum, wordVectorsDic):
        ...
        if os.path.exists('rakib_mstream_result/personal_cluster_biterm.txt'):
          os.remove('rakib_mstream_result/personal_cluster_biterm.txt')		
        ...
        listtuple_pred_true_text=ReadPredTrueText('rakib_mstream_result/PredTueTextMStream_WordArr.txt')
        Evaluate_old(listtuple_pred_true_text)
        listtuple_pred_true_text=ReadPredTrueText('rakib_mstream_result/personal_cluster_biterm.txt')
        Evaluate_old(listtuple_pred_true_text) 		
		
        if isProposed==True:
          print("listtuple_pred_true_text=ReadPredTrueText(rakib_mstream_result/mstr-enh)")		
    ...
    def run_MStreamF(self, documentSet, outputPath, wordList, AllBatchNum, wordVectorsDic):
        ...
        if os.path.exists("rakib_mstream_result/PredTueTextMStream_WordArr.txt"):
          os.remove("rakib_mstream_result/PredTueTextMStream_WordArr.txt")
        if os.path.exists('rakib_mstream_result/mstr-enh'):
          os.remove('rakib_mstream_result/mstr-enh')
        if os.path.exists('rakib_mstream_result/mstr-enh-sd'):
          os.remove('rakib_mstream_result/mstr-enh-sd')	
    ...
    def outputClusteringResult(self, outputDir, documentSet, batchNum):
        ...
        f = open("rakib_mstream_result/PredTueTextMStream_WordArr.txt", 'a')
        ...
        '''fileBatchWrire = open("rakib_mstream_result/batchId_PredTrueText"+str(batchNum), 'w')
